...
/// Postgres alike. Once every interior quote is doubled the sole unpaired
/// quotes are the delimiters, so `;`, a newline or `--` inside a name are
/// ordinary characters of it rather than a way out of the identifier.
///
