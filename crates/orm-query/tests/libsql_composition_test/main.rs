//! The query-composition scenarios executed against a real in-memory libsql
//! database (libsql-only lane): a recursive walk over a cyclic graph, set
...
#[path = "../fixtures/libsql_composition_db.rs"]
pub mod db;
