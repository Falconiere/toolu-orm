//! What `run_generate` writes for the first migration, for an incremental
//! change, and for a schema that has not changed at all.
...
use crate::support::{col, sample_registry, TestResult};
