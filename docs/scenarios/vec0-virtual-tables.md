...
| default | vec0_loop_sqlite_test | migrate_tests::migrating_vec0_without_the_extension_is_a_named_missing_module |
| default | vec0_loop_sqlite_test | migrate_tests::an_fts5_only_migration_still_applies_on_the_same_driver |
| default | vec0_loop_sqlite_test | generate_tests::regenerating_the_same_vec0_schema_finds_no_change |
| default | vec0_loop_sqlite_test | generate_tests::changing_the_dimension_is_refused_without_writing_a_migration |
| default | vec0_loop_sqlite_test | generate_tests::changing_the_distance_metric_is_refused_without_writing_a_migration |
| default | vec0_loop_sqlite_test | migrate_tests::a_driver_message_without_a_module_name_stays_database |
