...
| Lane | Binary | Test |
|---|---|---|
| default | migrate_embedded_test | apply_tests::an_embedded_list_applies_every_statement_of_every_migration |
| default | migrate_embedded_test | apply_tests::re_running_applies_nothing_and_a_new_entry_applies_alone |
| default | migrate_embedded_test | rejection_tests::an_edited_migration_fails_the_hash_check_after_the_earlier_one_applied |
| default | migrate_embedded_test | rejection_tests::a_repeated_name_is_rejected_before_anything_is_written |
| default | migrate_embedded_test | apply_tests::an_empty_list_still_creates_the_migrations_table |
| default | migrate_embedded_test | rejection_tests::a_failing_statement_rolls_back_only_its_own_migration |
| default | migrate_embedded_test | apply_tests::a_semicolon_chunk_without_breakpoint_applies_every_statement |
| default | migrate_embedded_test | rejection_tests::a_failing_semicolon_chunk_rolls_back_the_whole_migration |
| default | migrate_embedded_test | apply_tests::the_list_order_wins_over_the_name_order |
| default | migrate_embedded_test | rejection_tests::verify_hash_checks_a_migration_without_a_database |
| default | migrate_embedded_test | interchange_tests::a_directory_migrated_database_accepts_the_equivalent_embedded_list |
| default | migrate_embedded_test | interchange_tests::an_embedded_migrated_database_accepts_the_equivalent_directory |
| default | migrate_embedded_baseline_test | baseline_tests::baseline_records_the_list_hash_without_running_sql |
| default | migrate_embedded_baseline_test | baseline_tests::migrate_after_an_embedded_baseline_applies_only_the_suffix |
| default | migrate_embedded_baseline_test | rejection_tests::a_name_absent_from_the_list_records_nothing |
| default | migrate_embedded_baseline_test | rejection_tests::a_repeated_name_in_the_list_is_rejected_before_anything_is_written |
| default | migrate_embedded_baseline_test | baseline_tests::repeating_an_embedded_baseline_records_nothing_new |
| default | migrate_embedded_baseline_test | baseline_tests::an_empty_embedded_baseline_still_creates_the_migrations_table |
| default | migrate_embedded_baseline_test | baseline_tests::mark_applied_through_embedded_baselines_the_prefix_and_leaves_the_rest_pending |
